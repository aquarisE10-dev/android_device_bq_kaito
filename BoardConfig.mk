...
# Assert
TARGET_OTA_ASSERT_DEVICE := Aquaris_E10,kaito,kaito_wifi
...
# RIL
BOARD_RIL_CLASS := ../../../device/bq/kaito/ril/
...
BOARD_BOOTIMAGE_PARTITION_SIZE := 20971520  # 0x1400000
BOARD_RECOVERYIMAGE_PARTITION_SIZE := 20971520  # 0x1400000
BOARD_SYSTEMIMAGE_PARTITION_SIZE := 1283457024  # 0x4c800000
BOARD_USERDATAIMAGE_PARTITION_SIZE := 1237319680  # 0x49c00000
BOARD_CACHEIMAGE_PARTITION_SIZE := 1073741824  # 0x40000000
...
# Selinux
BOARD_SEPOLICY_DIRS += device/bq/kaito/sepolicy
